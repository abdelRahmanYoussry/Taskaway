  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        //               child: TasksWidget(
        //                   model:AppCubit.get(context).favouriteTasks[index] ,
        //                   height: mediaQuery.height/8,
        //                   isChecked: isChecked,
        //                   taskTitleColor: Colors.black,
        //                   popUpMenuColor: Colors.white,
        //                   checkBorderColor: Colors.white,
        //                   taskName: AppCubit.get(context).favouriteTasks[index]['title'],
        ...
        //             itemCount: AppCubit.get(context).favouriteTasks.length),
        ...
        //           ),
        //         ) ,
        //         condition:AppCubit.get(context).favouriteTasks.isNotEmpty ,
        //       ),
        //     ),
        //     Padding(
        //       padding: const EdgeInsets.all(20.0),
